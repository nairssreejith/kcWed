...
import kcDesk from "../assets/kc-desk.png";
        ...
        <div className="grid grid-cols-12 gap-6 md:gap-10 items-end">
          ...
          <div className="col-span-12 md:col-span-4 flex md:justify-end">
            <div className="relative">
              ...
              <div className="w-[280px] md:w-[320px] h-[360px] md:h-[420px] rounded-[28px] bg-[#2E1A24] text-[#FAF5EC] shadow-[0_20px_60px_-20px_rgba(46,26,36,0.45)] relative overflow-hidden">
                {/* Portrait photo */}
                <img
                  src={kcDesk}
                  alt={`${profile.name} at his desk`}
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(180deg, rgba(46,26,36,0.55) 0%, rgba(46,26,36,0.15) 30%, rgba(46,26,36,0.20) 55%, rgba(46,26,36,0.92) 100%)"
                  }}
                />
                ...
                <div className="relative h-full p-6 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="font-display text-2xl mt-2 drop-shadow-[0_2px_8px_rgba(0,0,0,0.6)]">{profile.fullTitle}</p>
                    <p className="font-mono-kc text-xs text-[#FAF5EC]/90 mt-1 drop-shadow-[0_2px_6px_rgba(0,0,0,0.6)]">as himself</p>
                  </div>
                  <div className="flex items-center justify-between border-t border-[#FAF5EC]/25 pt-4">
                    <span className="font-mono-kc text-[10px] tracking-[0.25em] uppercase text-[#E8B95E]">Rated P</span>
                    <span className="font-mono-kc text-[10px] uppercase tracking-[0.2em] text-[#FAF5EC]/80">for Personality</span>
                  </div>
                </div>
              </div>
            </div>
